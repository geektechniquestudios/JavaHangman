//Created by Terry Dorsey//
	...
	viewed as features, optimizations, and bug fixes. 
	...
	What's to come:
		...
		-an options menu using gridbag, OR maybe I'll just learn some other gui
		-the ability to modify the word bank by way of the options menu using the file object
		-possibly easy/hard mode. That's a big maybe though.
